...
//		for (int i = 1; i <= 12; i++) {
//			if (i % 4 == 0)	// 4의 배수 4,8,12
//				System.out.println("four");
//			else // 4의 배수에 four이 들어간다.
//				System.out.println(i);
//
//		}
//		int count = 0;
 ...
 * 1월 5일 과제
 * 
 * 가위 바위 보 게임을 총 15판 진행 게임을 진행 하면서 1판 끝날 때마다 몇승, 몇패, 몇무 출력하기
 * 
 * 
 */

/*
 * 반복문 - for, while, do~while 반복문이란 특정 코드를 정해진 횟수만큼 동작 시키는 과정이다. 또는 횟수의 제한 없이
 * 동작시 킬 수 있다.
 * 
 * for문 dowhile = 온라인 용 while = 적당한 반복
 * 
 * for( 초기값 ; 조건식; 증감식) (2~10 등 몇번 반복할지 기입한다. 초기 값이 필요하다){ 반복 실행할 내용; 반복 실행 할
 * 내용;
 * 
 * }
 * 
